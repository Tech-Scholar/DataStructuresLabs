...
public class ListLab1
{
   ...
   {
      // ListNode head = new ListNode(100, null);    //Java 1.5 automatically converts int to Integer, because a ListNode stores an Object
      ListNode head = new ListNode("head", null);  //ListNodes store Objects.
   ...
   public static ListNode rest(ListNode arg){
       ...
       return new ListNode(arg.getNext().getValue(), copyList(arg.getNext().getNext()));
   }
   /* enter your code here */
    ...
    public static ListNode copyOfLast(ListNode head){
        ListNode OGHead = pointerToLast(head);
        return new ListNode(OGHead.getValue(), 
        OGHead.getNext());
    }
